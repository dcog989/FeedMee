...
- **build**: `bun run build`
- **commits**: Conventional Commits, enforced by commitlint via lefthook (`commit-msg` hook) and CI. Types: `feat|fix|refactor|chore|docs|style|perf|test|build|ci|revert`.
