...
Inspiration: [Inoreader](https://www.inoreader.com/features/) / [NetNewsWire](https://netnewswire.com/), [Reeder](https://reederapp.com/), [Feedly](https://feedly.com/news-reader).
...
- Organize into nested folders that can be sorted
